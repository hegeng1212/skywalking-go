...
func (n *ConnRawInterceptor) BeforeInvoke(invocation operator.Invocation) error {
	return GeneralRawBeforeInvoke(invocation, "Conn/Raw")
}

func (n *ConnRawInterceptor) AfterInvoke(invocation operator.Invocation, results ...interface{}) error {
