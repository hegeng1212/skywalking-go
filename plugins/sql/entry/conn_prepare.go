...
func (n *ConnPrepareInterceptor) BeforeInvoke(invocation operator.Invocation) error {
	return GeneralPrepareBeforeInvoke(invocation, "Conn/Prepare")
}

func (n *ConnPrepareInterceptor) AfterInvoke(invocation operator.Invocation, results ...interface{}) error {
