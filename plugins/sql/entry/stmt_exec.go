...
func (n *StmtExecInterceptor) BeforeInvoke(invocation operator.Invocation) error {
...
func (n *StmtExecInterceptor) AfterInvoke(invocation operator.Invocation, results ...interface{}) error {
