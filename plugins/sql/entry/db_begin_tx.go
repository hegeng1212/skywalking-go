...
func (n *BeginTXInterceptor) BeforeInvoke(invocation operator.Invocation) error {
	return GeneralBeginTxBeforeInvoke(invocation, "BeginTx")
}

func (n *BeginTXInterceptor) AfterInvoke(invocation operator.Invocation, results ...interface{}) error {
