...
func (n *ConnPingInterceptor) BeforeInvoke(invocation operator.Invocation) error {
	return GeneralPingBeforeInvoke(invocation, "Conn/Ping")
}

func (n *ConnPingInterceptor) AfterInvoke(invocation operator.Invocation, results ...interface{}) error {
