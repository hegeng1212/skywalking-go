...
func (n *ConnBeginTXInterceptor) BeforeInvoke(invocation operator.Invocation) error {
	return GeneralBeginTxBeforeInvoke(invocation, "Conn/BeginTx")
}

func (n *ConnBeginTXInterceptor) AfterInvoke(invocation operator.Invocation, results ...interface{}) error {
