...
func (n *PrepareInterceptor) BeforeInvoke(invocation operator.Invocation) error {
	return GeneralPrepareBeforeInvoke(invocation, "Prepare")
}

func (n *PrepareInterceptor) AfterInvoke(invocation operator.Invocation, results ...interface{}) error {
