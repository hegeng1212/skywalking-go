...
func (n *TxRollbackInterceptor) BeforeInvoke(invocation operator.Invocation) error {
...
func (n *TxRollbackInterceptor) AfterInvoke(invocation operator.Invocation, results ...interface{}) error {
