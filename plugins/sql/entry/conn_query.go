...
func (n *ConnQueryInterceptor) BeforeInvoke(invocation operator.Invocation) error {
	return GeneralQueryBeforeInvoke(invocation, "Conn/Query")
}

func (n *ConnQueryInterceptor) AfterInvoke(invocation operator.Invocation, results ...interface{}) error {
