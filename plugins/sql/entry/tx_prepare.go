...
func (n *TxPrepareInterceptor) BeforeInvoke(invocation operator.Invocation) error {
	return GeneralPrepareBeforeInvoke(invocation, "Tx/Prepare")
}

func (n *TxPrepareInterceptor) AfterInvoke(invocation operator.Invocation, results ...interface{}) error {
