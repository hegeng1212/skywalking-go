...
func (h *HistogramObserveInterceptor) BeforeInvoke(_ operator.Invocation) error {
	return nil
}

func (h *HistogramObserveInterceptor) AfterInvoke(invocation operator.Invocation, result ...interface{}) error {
